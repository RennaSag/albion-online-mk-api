...
public class BancoDeDadosCraft {
    ...
    public static final String[] QUALIDADES = {
            ...
            case "" -> "ARTEFACT_2H_RAM_KEEPER;;Cepo Entalhado";
            case "" -> "ARTEFACT_2H_REPEATINGCROSSBOW_UNDEAD;;Mecanismo de Besta Perdido";
            case "" -> "ARTEFACT_2H_ROCKSTAFF_KEEPER;;Rochas Preservadas";
            case "" -> "ARTEFACT_2H_SKULLORB_HELL;;Mandíbula Amaldiçoada";
            case "" -> "ARTEFACT_2H_TRIDENT_UNDEAD;;Farpas Amaldiçoadas";
            case "" -> "ARTEFACT_2H_TWINSCYTHE_HELL;;Par de Cabeças de Foice Diabólicas";
            case "" -> "ARTEFACT_MAIN_ARCANESTAFF_UNDEAD;;Cristal Arcano Perdido";
            case "" -> "ARTEFACT_MAIN_CURSEDSTAFF_UNDEAD;;Cristal Amaldiçoado Perdido";
            case "" -> "ARTEFACT_MAIN_FIRESTAFF_KEEPER;;Orbe Incendiário";
            case "" -> "ARTEFACT_MAIN_FROSTSTAFF_KEEPER;;Orbe Enregelante";
            case "" -> "ARTEFACT_MAIN_MACE_HELL;;Cabeça de Maça Infernal";
            case "" -> "ARTEFACT_MAIN_NATURESTAFF_KEEPER;;Inscrições Druídicas";
            case "" -> "ARTEFACT_MAIN_RAPIER_MORGANA;;Débil Endurecido";
            case "" -> "ARTEFACT_MAIN_ROCKMACE_KEEPER;;Rocha com Runa";
            case "" -> "ARTEFACT_MAIN_SCIMITAR_MORGANA;;Lâmina Forjada em Sangue";
            case "" -> "ARTEFACT_MAIN_SPEAR_KEEPER;;Cabeça de Lança Protetora";
            case "" -> "ARTEFACT_2H_SCYTHE_HELL;;Cabeça de Foice Diabólica";
            case "" -> "ARTEFACT_2H_DAGGER_KATAR_AVALON;;Antiquidades Ensanguentadas";
            case "" -> "ARTEFACT_MAIN_SPEAR_LANCE_AVALON;;Vamplate Ancestral Arruinado";
            case "" -> "ARTEFACT_2H_AXE_AVALON;;Memórias de Batalha Avaloniana";
            case "" -> "ARTEFACT_2H_CLAYMORE_AVALON;;Restos do Velho Rei";
            case "" -> "ARTEFACT_2H_QUARTERSTAFF_AVALON;;Bengala Desgastada";
            case "" -> "ARTEFACT_2H_HAMMER_AVALON;;Mão Metálica";
            case "" -> "ARTEFACT_2H_DUALMACE_AVALON;;Juramentos Quebrados";
            case "" -> "ARTEFACT_2H_BOW_AVALON;;Tubo Bem Fabricado";
            case "" -> "ARTEFACT_2H_CROSSBOW_CANNON_AVALON;;Turbilhão Sussurrante Avaloniano";
            case "" -> "ARTEFACT_MAIN_CURSEDSTAFF_AVALON;;Orbe Opaca Fraturada";
            case "" -> "ARTEFACT_2H_FIRE_RINGPAIR_AVALON;;Anel Harmônico Brilhante";
            case "" -> "ARTEFACT_MAIN_FROSTSTAFF_AVALON;;Fragmento Cristalino Gelado";
            case "" -> "ARTEFACT_2H_ARCANE_RINGPAIR_AVALON;;Anel Harmônico Hipnótico";
            case "" -> "ARTEFACT_MAIN_HOLYSTAFF_AVALON;;Raridade Messiânica";
            case "" -> "ARTEFACT_MAIN_NATURESTAFF_AVALON;;Muda Desenraizada Perene";
            case "" -> "ARTEFACT_2H_KNUCKLES_KEEPER;;Restos de Guardião Ursino";
            case "" -> "ARTEFACT_2H_KNUCKLES_HELL;;Chifres Demoníacos Cortados";
            case "" -> "ARTEFACT_2H_KNUCKLES_MORGANA;;Placa de Corvo Deformado";
            case "" -> "ARTEFACT_2H_KNUCKLES_AVALON;;Manopla Avaloniana Danificada";
            case "" -> "ARTEFACT_MAIN_DAGGER_HELL;;Presa Demoníaca Quebrada";
            case "" -> "ARTEFACT_2H_SHAPESHIFTER_MORGANA;;Restos de Lobisomem";
            case "" -> "ARTEFACT_2H_SHAPESHIFTER_HELL;;Restos de Diabrete Infernal";
            case "" -> "ARTEFACT_2H_SHAPESHIFTER_KEEPER;;Restos de Golem de Pedra Rúnica";
            case "" -> "ARTEFACT_2H_SHAPESHIFTER_KEEPER;;Restos de Águia da Alvorada";
            case "" -> "ARTEFACT_2H_GLAIVE_CRYSTAL;;Cristal Fraturado";
            case "" -> "ARTEFACT_2H_ARCANESTAFF_CRYSTAL;;Cristal Estrelado";
            case "" -> "ARTEFACT_MAIN_SWORD_CRYSTAL;;Cristal Infinito";
            case "" -> "ARTEFACT_MAIN_SWORD_CRYSTAL;;Cristal Ilusório";
            case "" -> "ARTEFACT_2H_FROSTSTAFF_CRYSTAL;;Cristal Gelado";
            case "" -> "ARTEFACT_2H_SCYTHE_CRYSTAL;;Cristal Afiado";
            case "" -> "ARTEFACT_MAIN_MACE_CRYSTAL;;Cristal Tempestuoso";
            case "" -> "ARTEFACT_2H_HOLYSTAFF_CRYSTAL;;Cristal Exaltado";
            case "" -> "ARTEFACT_2H_DAGGERPAIR_CRYSTAL;;Cristal Mortífero";
            case "" -> "ARTEFACT_MAIN_CURSEDSTAFF_CRYSTAL;;Cristal Apodrecido";
            case "" -> "ARTEFACT_2H_KNUCKLES_CRYSTAL;;Cristal Pulsante";
            case "" -> "ARTEFACT_2H_BOW_CRYSTAL;;Cristal Aéreo";
            case "" -> "ARTEFACT_MAIN_FIRESTAFF_CRYSTAL;;Cristal Pírico";
            case "" -> "ARTEFACT_MAIN_NATURESTAFF_CRYSTAL;;Cristal Forjado";
            case "" -> "ARTEFACT_2H_DUALCROSSBOW_CRYSTAL;;Cristal Reluzente";
            case "" -> "ARTEFACT_2H_HAMMER_CRYSTAL;;Cristal Crepitante";
            case "" -> "ARTEFACT_2H_SHAPESHIFTER_CRYSTAL;;Cristal Serpentino";
            case "" -> "ARTEFACT_OFF_SHIELD_CRYSTAL;;Cristal Inquebrável";
            case "" -> "ARTEFACT_OFF_TORCH_CRYSTAL;;Cristal Chama Azul";
            case "" -> "ARTEFACT_OFF_TOME_CRYSTAL;;Cristal Estagnado";
            case "" -> "ARTEFACT_OFF_TOWERSHIELD_UNDEAD;;Núcleo de Escudo Ancestral";
            case "" -> "ARTEFACT_OFF_SHIELD_HELL;;Núcleo de Escudo Infernal";
            case "" -> "ARTEFACT_OFF_SPIKEDSHIELD_MORGANA;;Cavilhas Forjadas em Sangue";
            case "" -> "ARTEFACT_OFF_SHIELD_AVALON;;Relíquia Avaloniana Destruída";
            case "" -> "ARTEFACT_OFF_ORB_MORGANA;;Cristal Fascinante";
            case "" -> "ARTEFACT_OFF_DEMONSKULL_HELL;;Mandíbula Demoníaca";
            case "" -> "ARTEFACT_OFF_TOTEM_KEEPER;;Pedra Inscrita";
            case "" -> "ARTEFACT_OFF_CENSER_AVALON;;Lembrança Celestial Rompida";
            case "" -> "ARTEFACT_OFF_HORN_KEEPER;;Chifre com Runa";
            case "" -> "ARTEFACT_OFF_JESTERCANE_HELL;;Manípulo Diabólico";
            case "" -> "ARTEFACT_OFF_LAMP_UNDEAD;;Vela Sinistra";
            case "" -> "ARTEFACT_OFF_TALISMAN_AVALON;;Lembrança Avaloniana";

            case "" -> "ARTEFACT_HEAD_PLATE_UNDEAD;;Estofamento Ancestral";
            case "" -> "ARTEFACT_ARMOR_PLATE_UNDEAD;;Anilhas Ancestrais";
            case "" -> "ARTEFACT_SHOES_PLATE_UNDEAD;;Ataduras Ancestrais";
            case "" -> "ARTEFACT_HEAD_PLATE_HELL;;Restos Demoníacos";
            case "" -> "ARTEFACT_ARMOR_PLATE_HELL;;Placas Demoníacas";
            case "" -> "ARTEFACT_SHOES_PLATE_HELL;;Preenchimento Demoníaco";
            case "" -> "ARTEFACT_HEAD_PLATE_KEEPER;;Estofamento de Caveira Entalhada";
            case "" -> "ARTEFACT_ARMOR_PLATE_KEEPER;;Pele Preservada";
            case "" -> "ARTEFACT_SHOES_PLATE_KEEPER;;Ataduras Inscritas";
            case "" -> "ARTEFACT_HEAD_PLATE_AVALON;;Viseira Elevada";
            case "" -> "ARTEFACT_ARMOR_PLATE_AVALON;;Couraça Elevada";
            case "" -> "ARTEFACT_SHOES_PLATE_AVALON;;Perneira Elevada";
            case "" -> "ARTEFACT_ARMOR_PLATE_FEY;;Carapaça da Tecelã";
            case "" -> "ARTEFACT_HEAD_PLATE_FEY;;Mandíbulas da Tecelã";
            case "" -> "ARTEFACT_SHOES_PLATE_FEY;;Garras da Tecelã";
            case "" -> "ARTEFACT_HEAD_LEATHER_MORGANA;;Visor Imbuído";
            case "" -> "ARTEFACT_ARMOR_LEATHER_MORGANA;;Peças de Couro Imbuído";
            case "" -> "ARTEFACT_SHOES_LEATHER_MORGANA;;Solas Imbuídas";
            case "" -> "ARTEFACT_HEAD_LEATHER_HELL;;Estofamento de Pele Demoníaca";
            case "" -> "ARTEFACT_ARMOR_LEATHER_HELL;;Couro de Pele Demoníaca";
            case "" -> "ARTEFACT_SHOES_LEATHER_HELL;;Ataduras de Pele Demoníaca";
            case "" -> "ARTEFACT_HEAD_LEATHER_UNDEAD;;Visor Sinistro";
            case "" -> "ARTEFACT_SHOES_LEATHER_UNDEAD;;Ataduras Sinistras";
            case "" -> "ARTEFACT_HEAD_LEATHER_AVALON;;Estofamento Augurado";
            case "" -> "ARTEFACT_ARMOR_LEATHER_AVALON;;Cinturão Augurado";
            case "" -> "ARTEFACT_SHOES_LEATHER_AVALON;;Botas Auguradas";
            case "" -> "ARTEFACT_ARMOR_LEATHER_FEY;;Penas de Grifo Imaculadas";
            case "" -> "ARTEFACT_HEAD_LEATHER_FEY;;Bico de Grifo Impecável";
            case "" -> "ARTEFACT_SHOES_LEATHER_FEY;;Penugem de Grifo";
            case "" -> "ARTEFACT_HEAD_CLOTH_KEEPER;;Bico Preservado";
            case "" -> "ARTEFACT_ARMOR_CLOTH_KEEPER;;Penas Druídicas";
            case "" -> "ARTEFACT_SHOES_CLOTH_KEEPER;;Ataduras Druídicas";
            case "" -> "ARTEFACT_HEAD_CLOTH_HELL;;Visor de Tecido Infernal";
            case "" -> "ARTEFACT_ARMOR_CLOTH_HELL;;Peças de Tecido Infernal";
            case "" -> "ARTEFACT_SHOES_CLOTH_HELL;;Ataduras de Tecido Infernal";
            case "" -> "ARTEFACT_HEAD_CLOTH_MORGANA;;Estofamento Fascinante";
            case "" -> "ARTEFACT_ARMOR_CLOTH_MORGANA;;Amuleto Fascinante";
            case "" -> "ARTEFACT_SHOES_CLOTH_MORGANA;;Ataduras Fascinantes";
            case "" -> "ARTEFACT_HEAD_CLOTH_AVALON;;Máscara Santificada";
            case "" -> "ARTEFACT_ARMOR_CLOTH_AVALON;;Cinto Santificado";
            case "" -> "ARTEFACT_SHOES_CLOTH_AVALON;;Ligaduras Santificadas";
            case "" -> "ARTEFACT_ARMOR_CLOTH_FEY;;Asa de Fada";
            case "" -> "ARTEFACT_HEAD_CLOTH_FEY;;Fíbula Intacta de Fada";
            case "" -> "ARTEFACT_SHOES_CLOTH_FEY;;Escamas Feéricas";
            ...
            case "" -> "CAPEITEM_FW_BRIDGEWATCH_BP;;Ornamento de Bridgewatch";
            case "" -> "CAPEITEM_FW_FORTSTERLING_BP;;Ornamento de FortSterling";
            case "" -> "CAPEITEM_FW_LYMHURST_BP;;Ornamento de Lymhurst";
            case "" -> "CAPEITEM_FW_MARTLOCK_BP;;Ornamento de Martlock";
            case "" -> "CAPEITEM_FW_THETFORD_BP;;Ornamento de Thetford";
            case "" -> "CAPEITEM_FW_CAERLEON_BP;;Ornamento de Caerleon";
            case "" -> "CAPEITEM_SMUGGLER_BP;;Ornamento de Contrabandista";
            case "" -> "CAPEITEM_FW_BRECILIEN_BP;;Ornamento de Brecellien";
            case "" -> "CAPEITEM_AVALON_BP;;Ornamento Avaloniano";
            case "" -> "CAPEITEM_HERETIC_BP;;Ornamento do Herege";
            case "" -> "CAPEITEM_UNDEAD_BP;;Ornamento Morto-vivo";
            case "" -> "CAPEITEM_KEEPER_BP;;Ornamento Protetor";
            case "" -> "CAPEITEM_MORGANA_BP;;Ornamento de Morgana";
            case "" -> "CAPEITEM_DEMON_BP;;Ornamento Demoníaco";
*/
