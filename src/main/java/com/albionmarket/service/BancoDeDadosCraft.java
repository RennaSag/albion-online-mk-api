...
public class BancoDeDadosCraft {
    ...
    public static final String[] QUALIDADES = {
            ...
            case "" -> "ARTEFACT_TOKEN_FAVOR_3;;Magia Cristalizada";
            case "" -> "ARTEFACT_TOKEN_FAVOR_4;;Divindade Cristalizada";
            case "" -> "RUNE;;Runa";
            case "" -> "SOUL;;Alma";
            case "" -> "SHARD_AVALONIAN;;Fragmento de Avalon";
    ...
    public static String getArtefatoSufixo(String itemId) {
        ...
        return switch (base) {
            ...
            case "2H_CLEAVER_HELL" -> "ARTEFACT_2H_CLEAVER_HELL;;Lâmina Demoníaca";
            case "2H_COMBATSTAFF_MORGANA" -> "ARTEFACT_2H_COMBATSTAFF_MORGANA;;Estaca de Morgana Reforçada";
            case "2H_CROSSBOWLARGE_MORGANA" -> "ARTEFACT_2H_CROSSBOWLARGE_MORGANA;;Virotes Fascinantes";
            case "2H_CURSEDSTAFF_MORGANA" -> "ARTEFACT_2H_CURSEDSTAFF_MORGANA;;Catalizador Forjado em Sangue";
            case "2H_DUALAXE_KEEPER" -> "ARTEFACT_2H_DUALAXE_KEEPER;;Cabeças de Machado Protetoras";
            case "2H_DUALCROSSBOW_HELL" -> "ARTEFACT_2H_DUALCROSSBOW_HELL;;Virotes Diabólicos";
            case "2H_DUALSCIMITAR_UNDEAD" -> "ARTEFACT_2H_DUALSCIMITAR_UNDEAD;;Lâminas Amaldiçoadas";
            case "2H_DUALSICKLE_UNDEAD" -> "ARTEFACT_2H_DUALSICKLE_UNDEAD;;Lâminas Sinistras";
            case "2H_ENIGMATICORB_MORGANA" -> "ARTEFACT_2H_ENIGMATICORB_MORGANA;;Catalisador Possuído";
            case "2H_FIRESTAFF_HELL" -> "ARTEFACT_2H_FIRESTAFF_HELL;;Orbe Inflamado";
            case "2H_HALBERD_MORGANA" -> "ARTEFACT_2H_HALBERD_MORGANA;;Cabeça de Alabarda";
            case "2H_HARPOON_HELL" -> "ARTEFACT_2H_HARPOON_HELL;;Ponta de Arpão Infernal";
            case "MAIN_HOLYSTAFF_MORGANA" -> "ARTEFACT_MAIN_HOLYSTAFF_MORGANA;;Pergaminho Possuído";
            case "2H_HOLYSTAFF_UNDEAD" -> "ARTEFACT_2H_HOLYSTAFF_UNDEAD;;Pergaminho Sinistro";
            case "2H_ICECRYSTAL_UNDEAD" -> "ARTEFACT_2H_ICECRYSTAL_UNDEAD;;Cristal Congelado Amaldiçoado";
            case "2H_ICEGAUNTLETS_HELL" -> "ARTEFACT_2H_ICEGAUNTLETS_HELL;;Órbe Sincelo";
            case "2H_INFERNOSTAFF_MORGANA" -> "ARTEFACT_2H_INFERNOSTAFF_MORGANA;;Pergaminho Profano";
            case "2H_LONGBOW_UNDEAD" -> "ARTEFACT_2H_LONGBOW_UNDEAD;;Flechas Sinistras";
            case "2H_MACE_MORGANA" -> "ARTEFACT_2H_MACE_MORGANA;;Cabeça de Maça Imbuída";
            case "2H_NATURESTAFF_HELL" -> "ARTEFACT_2H_NATURESTAFF_HELL;;Símbolo de Malignidade";
            case "2H_NATURESTAFF_KEEPER" -> "ARTEFACT_2H_NATURESTAFF_KEEPER;;Cepo Preservado";
            case "2H_RAM_KEEPER" -> "ARTEFACT_2H_RAM_KEEPER;;Cepo Entalhado";
            case "2H_REPEATINGCROSSBOW_UNDEAD" -> "ARTEFACT_2H_REPEATINGCROSSBOW_UNDEAD;;Mecanismo de Besta Perdido";
            case "2H_ROCKSTAFF_KEEPER" -> "ARTEFACT_2H_ROCKSTAFF_KEEPER;;Rochas Preservadas";
            case "2H_SKULLORB_HELL" -> "ARTEFACT_2H_SKULLORB_HELL;;Mandíbula Amaldiçoada";
            case "2H_TRIDENT_UNDEAD" -> "ARTEFACT_2H_TRIDENT_UNDEAD;;Farpas Amaldiçoadas";
            case "2H_TWINSCYTHE_HELL" -> "ARTEFACT_2H_TWINSCYTHE_HELL;;Par de Cabeças de Foice Diabólicas";
            case "MAIN_ARCANESTAFF_UNDEAD" -> "ARTEFACT_MAIN_ARCANESTAFF_UNDEAD;;Cristal Arcano Perdido";
            case "MAIN_CURSEDSTAFF_UNDEAD" -> "ARTEFACT_MAIN_CURSEDSTAFF_UNDEAD;;Cristal Amaldiçoado Perdido";
            case "MAIN_FIRESTAFF_KEEPER" -> "ARTEFACT_MAIN_FIRESTAFF_KEEPER;;Orbe Incendiário";
            case "MAIN_FROSTSTAFF_KEEPER" -> "ARTEFACT_MAIN_FROSTSTAFF_KEEPER;;Orbe Enregelante";
            case "MAIN_MACE_HELL" -> "ARTEFACT_MAIN_MACE_HELL;;Cabeça de Maça Infernal";
            case "MAIN_NATURESTAFF_KEEPER" -> "ARTEFACT_MAIN_NATURESTAFF_KEEPER;;Inscrições Druídicas";
            case "MAIN_RAPIER_MORGANA" -> "ARTEFACT_MAIN_RAPIER_MORGANA;;Débil Endurecido";
            case "MAIN_ROCKMACE_KEEPER" -> "ARTEFACT_MAIN_ROCKMACE_KEEPER;;Rocha com Runa";
            case "MAIN_SCIMITAR_MORGANA" -> "ARTEFACT_MAIN_SCIMITAR_MORGANA;;Lâmina Forjada em Sangue";
            case "MAIN_SPEAR_KEEPER" -> "ARTEFACT_MAIN_SPEAR_KEEPER;;Cabeça de Lança Protetora";
            case "2H_SCYTHE_HELL" -> "ARTEFACT_2H_SCYTHE_HELL;;Cabeça de Foice Diabólica";
            case "2H_DAGGER_KATAR_AVALON" -> "ARTEFACT_2H_DAGGER_KATAR_AVALON;;Antiquidades Ensanguentadas";
            case "MAIN_SPEAR_LANCE_AVALON" -> "ARTEFACT_MAIN_SPEAR_LANCE_AVALON;;Vamplate Ancestral Arruinado";
            case "2H_AXE_AVALON" -> "ARTEFACT_2H_AXE_AVALON;;Memórias de Batalha Avaloniana";
            case "2H_CLAYMORE_AVALON" -> "ARTEFACT_2H_CLAYMORE_AVALON;;Restos do Velho Rei";
            case "2H_QUARTERSTAFF_AVALON" -> "ARTEFACT_2H_QUARTERSTAFF_AVALON;;Bengala Desgastada";
            case "2H_HAMMER_AVALON" -> "ARTEFACT_2H_HAMMER_AVALON;;Mão Metálica";
            case "2H_DUALMACE_AVALON" -> "ARTEFACT_2H_DUALMACE_AVALON;;Juramentos Quebrados";
            case "2H_BOW_AVALON" -> "ARTEFACT_2H_BOW_AVALON;;Tubo Bem Fabricado";
            case "2H_CROSSBOW_CANNON_AVALON" -> "ARTEFACT_2H_CROSSBOW_CANNON_AVALON;;Turbilhão Sussurrante Avaloniano";
            case "MAIN_CURSEDSTAFF_AVALON" -> "ARTEFACT_MAIN_CURSEDSTAFF_AVALON;;Orbe Opaca Fraturada";
            case "2H_FIRE_RINGPAIR_AVALON" -> "ARTEFACT_2H_FIRE_RINGPAIR_AVALON;;Anel Harmônico Brilhante";
            case "MAIN_FROSTSTAFF_AVALON" -> "ARTEFACT_MAIN_FROSTSTAFF_AVALON;;Fragmento Cristalino Gelado";
            case "2H_ARCANE_RINGPAIR_AVALON" -> "ARTEFACT_2H_ARCANE_RINGPAIR_AVALON;;Anel Harmônico Hipnótico";
            case "MAIN_HOLYSTAFF_AVALON" -> "ARTEFACT_MAIN_HOLYSTAFF_AVALON;;Raridade Messiânica";
            case "MAIN_NATURESTAFF_AVALON" -> "ARTEFACT_MAIN_NATURESTAFF_AVALON;;Muda Desenraizada Perene";
            case "2H_KNUCKLES_KEEPER" -> "ARTEFACT_2H_KNUCKLES_KEEPER;;Restos de Guardião Ursino";
            case "2H_KNUCKLES_HELL" -> "ARTEFACT_2H_KNUCKLES_HELL;;Chifres Demoníacos Cortados";
            case "2H_KNUCKLES_MORGANA" -> "ARTEFACT_2H_KNUCKLES_MORGANA;;Placa de Corvo Deformado";
            case "2H_KNUCKLES_AVALON" -> "ARTEFACT_2H_KNUCKLES_AVALON;;Manopla Avaloniana Danificada";
            case "MAIN_DAGGER_HELL" -> "ARTEFACT_MAIN_DAGGER_HELL;;Presa Demoníaca Quebrada";
            case "2H_SHAPESHIFTER_MORGANA" -> "ARTEFACT_2H_SHAPESHIFTER_MORGANA;;Restos de Lobisomem";
            case "2H_SHAPESHIFTER_HELL" -> "ARTEFACT_2H_SHAPESHIFTER_HELL;;Restos de Diabrete Infernal";
            case "2H_SHAPESHIFTER_KEEPER" -> "ARTEFACT_2H_SHAPESHIFTER_KEEPER;;Restos de Golem de Pedra Rúnica";
            case "2H_SHAPESHIFTER_AVALON" -> "ARTEFACT_2H_SHAPESHIFTER_AVALON;;Restos de Águia da Alvorada";
            case "2H_GLAIVE_CRYSTAL" -> "ARTEFACT_2H_GLAIVE_CRYSTAL;;Cristal Fraturado";
            case "2H_ARCANESTAFF_CRYSTAL" -> "ARTEFACT_2H_ARCANESTAFF_CRYSTAL;;Cristal Estrelado";
            case "MAIN_ENIGMATICORB_AVALON" -> "ARTEFACT_MAIN_SWORD_CRYSTAL;;Cristal Infinito";
            case "2H_DOUBLEBLADEDSTAFF_CRYSTAL" -> "ARTEFACT_MAIN_SWORD_CRYSTAL;;Cristal Ilusório";
            case "2H_FROSTSTAFF_CRYSTAL" -> "ARTEFACT_2H_FROSTSTAFF_CRYSTAL;;Cristal Gelado";
            case "2H_SCYTHE_CRYSTAL" -> "ARTEFACT_2H_SCYTHE_CRYSTAL;;Cristal Afiado";
            case "MAIN_MACE_CRYSTAL" -> "ARTEFACT_MAIN_MACE_CRYSTAL;;Cristal Tempestuoso";
            case "2H_HOLYSTAFF_CRYSTAL" -> "ARTEFACT_2H_HOLYSTAFF_CRYSTAL;;Cristal Exaltado";
            case "2H_DAGGERPAIR_CRYSTAL" -> "ARTEFACT_2H_DAGGERPAIR_CRYSTAL;;Cristal Mortífero";
            case "MAIN_CURSEDSTAFF_CRYSTAL" -> "ARTEFACT_MAIN_CURSEDSTAFF_CRYSTAL;;Cristal Apodrecido";
            case "2H_KNUCKLES_CRYSTAL" -> "ARTEFACT_2H_KNUCKLES_CRYSTAL;;Cristal Pulsante";
            case "2H_BOW_CRYSTAL" -> "ARTEFACT_2H_BOW_CRYSTAL;;Cristal Aéreo";
            case "MAIN_FIRESTAFF_CRYSTAL" -> "ARTEFACT_MAIN_FIRESTAFF_CRYSTAL;;Cristal Pírico";
            case "MAIN_NATURESTAFF_CRYSTAL" -> "ARTEFACT_MAIN_NATURESTAFF_CRYSTAL;;Cristal Forjado";
            case "2H_DUALCROSSBOW_CRYSTAL" -> "ARTEFACT_2H_DUALCROSSBOW_CRYSTAL;;Cristal Reluzente";
            case "2H_HAMMER_CRYSTAL" -> "ARTEFACT_2H_HAMMER_CRYSTAL;;Cristal Crepitante";
            case "2H_SHAPESHIFTER_CRYSTAL" -> "ARTEFACT_2H_SHAPESHIFTER_CRYSTAL;;Cristal Serpentino";
            case "OFF_SHIELD_CRYSTAL" -> "ARTEFACT_OFF_SHIELD_CRYSTAL;;Cristal Inquebrável";
            case "OFF_TORCH_CRYSTAL" -> "ARTEFACT_OFF_TORCH_CRYSTAL;;Cristal Chama Azul";
            case "OFF_TOME_CRYSTAL" -> "ARTEFACT_OFF_TOME_CRYSTAL;;Cristal Estagnado";
            case "OFF_TOWERSHIELD_UNDEAD" -> "ARTEFACT_OFF_TOWERSHIELD_UNDEAD;;Núcleo de Escudo Ancestral";
            case "OFF_SHIELD_HELL" -> "ARTEFACT_OFF_SHIELD_HELL;;Núcleo de Escudo Infernal";
            case "OFF_SPIKEDSHIELD_MORGANA" -> "ARTEFACT_OFF_SPIKEDSHIELD_MORGANA;;Cavilhas Forjadas em Sangue";
            case "OFF_SHIELD_AVALON" -> "ARTEFACT_OFF_SHIELD_AVALON;;Relíquia Avaloniana Destruída";
            case "OFF_ORB_MORGANA" -> "ARTEFACT_OFF_ORB_MORGANA;;Cristal Fascinante";
            case "OFF_DEMONSKULL_HELL" -> "ARTEFACT_OFF_DEMONSKULL_HELL;;Mandíbula Demoníaca";
            case "OFF_TOTEM_KEEPER" -> "ARTEFACT_OFF_TOTEM_KEEPER;;Pedra Inscrita";
            case "OFF_CENSER_AVALON" -> "ARTEFACT_OFF_CENSER_AVALON;;Lembrança Celestial Rompida";
            case "OFF_HORN_KEEPER" -> "ARTEFACT_OFF_HORN_KEEPER;;Chifre com Runa";
            case "OFF_JESTERCANE_HELL" -> "ARTEFACT_OFF_JESTERCANE_HELL;;Manípulo Diabólico";
            case "OFF_LAMP_UNDEAD" -> "ARTEFACT_OFF_LAMP_UNDEAD;;Vela Sinistra";
            case "OFF_TALISMAN_AVALON" -> "ARTEFACT_OFF_TALISMAN_AVALON;;Lembrança Avaloniana";
            case "HEAD_PLATE_UNDEAD" -> "ARTEFACT_HEAD_PLATE_UNDEAD;;Estofamento Ancestral";
            case "ARMOR_PLATE_UNDEAD" -> "ARTEFACT_ARMOR_PLATE_UNDEAD;;Anilhas Ancestrais";
            case "SHOES_PLATE_UNDEAD" -> "ARTEFACT_SHOES_PLATE_UNDEAD;;Ataduras Ancestrais";
            case "HEAD_PLATE_HELL" -> "ARTEFACT_HEAD_PLATE_HELL;;Restos Demoníacos";
            case "ARMOR_PLATE_HELL" -> "ARTEFACT_ARMOR_PLATE_HELL;;Placas Demoníacas";
            case "SHOES_PLATE_HELL" -> "ARTEFACT_SHOES_PLATE_HELL;;Preenchimento Demoníaco";
            case "HEAD_PLATE_KEEPER" -> "ARTEFACT_HEAD_PLATE_KEEPER;;Estofamento de Caveira Entalhada";
            case "ARMOR_PLATE_KEEPER" -> "ARTEFACT_ARMOR_PLATE_KEEPER;;Pele Preservada";
            case "SHOES_PLATE_KEEPER" -> "ARTEFACT_SHOES_PLATE_KEEPER;;Ataduras Inscritas";
            case "HEAD_PLATE_AVALON" -> "ARTEFACT_HEAD_PLATE_AVALON;;Viseira Elevada";
            case "ARMOR_PLATE_AVALON" -> "ARTEFACT_ARMOR_PLATE_AVALON;;Couraça Elevada";
            case "SHOES_PLATE_AVALON" -> "ARTEFACT_SHOES_PLATE_AVALON;;Perneira Elevada";
            case "ARMOR_PLATE_FEY" -> "ARTEFACT_ARMOR_PLATE_FEY;;Carapaça da Tecelã";
            case "HEAD_PLATE_FEY" -> "ARTEFACT_HEAD_PLATE_FEY;;Mandíbulas da Tecelã";
            case "SHOES_PLATE_FEY" -> "ARTEFACT_SHOES_PLATE_FEY;;Garras da Tecelã";
            case "HEAD_LEATHER_MORGANA" -> "ARTEFACT_HEAD_LEATHER_MORGANA;;Visor Imbuído";
            case "ARMOR_LEATHER_MORGANA" -> "ARTEFACT_ARMOR_LEATHER_MORGANA;;Peças de Couro Imbuído";
            case "SHOES_LEATHER_MORGANA" -> "ARTEFACT_SHOES_LEATHER_MORGANA;;Solas Imbuídas";
            case "HEAD_LEATHER_HELL" -> "ARTEFACT_HEAD_LEATHER_HELL;;Estofamento de Pele Demoníaca";
            case "ARMOR_LEATHER_HELL" -> "ARTEFACT_ARMOR_LEATHER_HELL;;Couro de Pele Demoníaca";
            case "SHOES_LEATHER_HELL" -> "ARTEFACT_SHOES_LEATHER_HELL;;Ataduras de Pele Demoníaca";
            case "HEAD_LEATHER_UNDEAD" -> "ARTEFACT_HEAD_LEATHER_UNDEAD;;Visor Sinistro";
            case "SHOES_LEATHER_UNDEAD" -> "ARTEFACT_SHOES_LEATHER_UNDEAD;;Ataduras Sinistras";
            case "HEAD_LEATHER_AVALON" -> "ARTEFACT_HEAD_LEATHER_AVALON;;Estofamento Augurado";
            case "ARMOR_LEATHER_AVALON" -> "ARTEFACT_ARMOR_LEATHER_AVALON;;Cinturão Augurado";
            case "SHOES_LEATHER_AVALON" -> "ARTEFACT_SHOES_LEATHER_AVALON;;Botas Auguradas";
            case "ARMOR_LEATHER_FEY" -> "ARTEFACT_ARMOR_LEATHER_FEY;;Penas de Grifo Imaculadas";
            case "HEAD_LEATHER_FEY" -> "ARTEFACT_HEAD_LEATHER_FEY;;Bico de Grifo Impecável";
            case "SHOES_LEATHER_FEY" -> "ARTEFACT_SHOES_LEATHER_FEY;;Penugem de Grifo";
            case "HEAD_CLOTH_KEEPER" -> "ARTEFACT_HEAD_CLOTH_KEEPER;;Bico Preservado";
            case "ARMOR_CLOTH_KEEPER" -> "ARTEFACT_ARMOR_CLOTH_KEEPER;;Penas Druídicas";
            case "SHOES_CLOTH_KEEPER" -> "ARTEFACT_SHOES_CLOTH_KEEPER;;Ataduras Druídicas";
            case "HEAD_CLOTH_HELL" -> "ARTEFACT_HEAD_CLOTH_HELL;;Visor de Tecido Infernal";
            case "ARMOR_CLOTH_HELL" -> "ARTEFACT_ARMOR_CLOTH_HELL;;Peças de Tecido Infernal";
            case "SHOES_CLOTH_HELL" -> "ARTEFACT_SHOES_CLOTH_HELL;;Ataduras de Tecido Infernal";
            case "HEAD_CLOTH_MORGANA" -> "ARTEFACT_HEAD_CLOTH_MORGANA;;Estofamento Fascinante";
            case "ARMOR_CLOTH_MORGANA" -> "ARTEFACT_ARMOR_CLOTH_MORGANA;;Amuleto Fascinante";
            case "SHOES_CLOTH_MORGANA" -> "ARTEFACT_SHOES_CLOTH_MORGANA;;Ataduras Fascinantes";
            case "HEAD_CLOTH_AVALON" -> "ARTEFACT_HEAD_CLOTH_AVALON;;Máscara Santificada";
            case "ARMOR_CLOTH_AVALON" -> "ARTEFACT_ARMOR_CLOTH_AVALON;;Cinto Santificado";
            case "SHOES_CLOTH_AVALON" -> "ARTEFACT_SHOES_CLOTH_AVALON;;Ligaduras Santificadas";
            case "ARMOR_CLOTH_FEY" -> "ARTEFACT_ARMOR_CLOTH_FEY;;Asa de Fada";
            case "HEAD_CLOTH_FEY" -> "ARTEFACT_HEAD_CLOTH_FEY;;Fíbula Intacta de Fada";
            case "SHOES_CLOTH_FEY" -> "ARTEFACT_SHOES_CLOTH_FEY;;Escamas Feéricas";
            case "CAPEITEM_FW_BRIDGEWATCH_BP" -> "CAPEITEM_FW_BRIDGEWATCH_BP;;Ornamento de Bridgewatch";
            case "CAPEITEM_FW_FORTSTERLING_BP" -> "CAPEITEM_FW_FORTSTERLING_BP;;Ornamento de FortSterling";
            case "CAPEITEM_FW_LYMHURST_BP" -> "CAPEITEM_FW_LYMHURST_BP;;Ornamento de Lymhurst";
            case "CAPEITEM_FW_MARTLOCK_BP" -> "CAPEITEM_FW_MARTLOCK_BP;;Ornamento de Martlock";
            case "CAPEITEM_FW_THETFORD_BP" -> "CAPEITEM_FW_THETFORD_BP;;Ornamento de Thetford";
            case "CAPEITEM_FW_CAERLEON_BP" -> "CAPEITEM_FW_CAERLEON_BP;;Ornamento de Caerleon";
            case "CAPEITEM_SMUGGLER_BP" -> "CAPEITEM_SMUGGLER_BP;;Ornamento de Contrabandista";
            case "CAPEITEM_FW_BRECILIEN_BP" -> "CAPEITEM_FW_BRECILIEN_BP;;Ornamento de Brecellien";
            case "CAPEITEM_AVALON_BP" -> "CAPEITEM_AVALON_BP;;Ornamento Avaloniano";
            case "CAPEITEM_HERETIC_BP" -> "CAPEITEM_HERETIC_BP;;Ornamento do Herege";
            case "CAPEITEM_UNDEAD_BP" -> "CAPEITEM_UNDEAD_BP;;Ornamento Morto-vivo";
            case "CAPEITEM_KEEPER_BP" -> "CAPEITEM_KEEPER_BP;;Ornamento Protetor";
            case "CAPEITEM_MORGANA_BP" -> "CAPEITEM_MORGANA_BP;;Ornamento de Morgana";
            case "CAPEITEM_DEMON_BP" -> "CAPEITEM_DEMON_BP;;Ornamento Demoníaco";
