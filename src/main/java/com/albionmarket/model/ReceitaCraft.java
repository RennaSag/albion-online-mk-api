...
/**
 * receita de craft dos itens retornada pela gameinfo API.
 */
public class ReceitaCraft {
    ...
    public int                 getCraftingFocus() { return craftingFocus; }
    public List<MaterialCraft> getMateriais()     { return materiais; }
    ...
    public static class MaterialCraft {
        ...
        public boolean isArtefato()    { return ehArtefato; }
