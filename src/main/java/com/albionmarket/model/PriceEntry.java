...
public class PriceEntry {
    ...
    private final long sellMin;     // preço mínimo de venda
    private final long buyMax;      // preço máximo de compra
    private final String sellDate;  // data da última atualização do pedido de venda
    private final String buyDate;   // data da última atualização do pedido de compra
    ...
    public long   getSellMin()  { return sellMin; }
    public long   getBuyMax()   { return buyMax; }
