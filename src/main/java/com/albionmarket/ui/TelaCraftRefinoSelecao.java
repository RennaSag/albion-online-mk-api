...
public class TelaCraftRefinoSelecao {

    private static final String PREF_TIER      = "craftrefino_tier";
    private static final String PREF_ENCHANT   = "craftrefino_enchant";
    private static final String PREF_ITEM_ID   = "craftrefino_item_id";
    private static final String PREF_ITEM_NOME = "craftrefino_item_nome";
    private static final String PREF_BUSCA     = "craftrefino_busca";
    private static final Preferences PREFS     =
            Preferences.userNodeForPackage(TelaCraftRefinoSelecao.class);

    private final Stage palco;
    private final BuscaService buscaService = new BuscaService();
    private final List<Categoria> categorias = BancoDeDadosItens.getCategorias();
    ...
    public TelaCraftRefinoSelecao(Stage palco) {
        this.palco = palco;
        this.estadoAnterior = null;
    }

    public TelaCraftRefinoSelecao(Stage palco, EstadoSelecao estado) {
        this.palco = palco;
    ...
    public void mostrar() {
        ...
        palco.setTitle("Craft + Refino - Selecao de Item");
    ...
    private HBox criarCabecalho() {
        ...
        Label subtitulo = new Label("O que vamos craftar (com refino incluso)?");
    ...
    private void onSelecionar() {
        ...
        new TelaCraftRefino(palco, item, tier, enchant, estado).mostrar();
    }
    ...
    private void carregarPreferencias() {
        ...
        ItemDefinition found = BancoDeDadosItens.getTodosItens().stream()
